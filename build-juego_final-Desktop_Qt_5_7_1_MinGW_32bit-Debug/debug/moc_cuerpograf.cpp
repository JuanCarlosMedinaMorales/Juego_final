/****************************************************************************
** Meta object code from reading C++ file 'cuerpograf.h'
**
...
#include "../../juego_final/cuerpograf.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'cuerpograf.h' doesn't include <QObject>."
...
const QMetaObject grafica::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_grafica.data,
...
void *grafica::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< grafica*>(this));
