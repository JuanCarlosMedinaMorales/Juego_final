...
#include "../../Juego_Final01/partidas.h"
...
QT_MOC_LITERAL(3, 32, 23) // "on_pushButton_2_clicked"
    ...
    "partidas\0on_pushButton_clicked\0\0"
...
void partidas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        partidas *_t = static_cast<partidas *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject partidas::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_partidas.data,
      qt_meta_data_partidas,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *partidas::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_partidas.stringdata0))
        return static_cast<void*>(const_cast< partidas*>(this));
